...
TASK_SYSTEM_PROMPTS: dict = {
    ...
    "triage_queue": (
        ...
        "  'low'      = questions, feature requests, minor inconvenience, no deadline\n"
        "ESCALATION PRIORITY (highest to lowest): human safety > active security breach > "
        "payments/data loss at scale > system-wide outage > revenue impact > team blocked > individual.\n"
        "When multiple criticals exist, escalate the one with the widest ongoing impact.\n"
